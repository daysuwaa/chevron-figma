...
const UploadDrop = ({ handleDrop }) => {
  ...
  const handleDragOver = (e) => {
    ...
    if (!hasExcelFile) {
      // Prevent dropping if no Excel file is detected
  ...
  return (
    <div
      className={`mx-auto items-center mt-1 text-[#4A5568] justify-center w-full rounded border border-[#CBD5E0] border-dashed border-focus-within:outline outline-2 px-10 ${
...
const BeneficiaryUploader = ({ beneficiaryFile, setBeneficiaryFile }) => {
      ...
      <div className="md:mx-auto">
        ...
        {beneficiaryFile ? (
          <div>
            ...
            <button
              onClick={() => setBeneficiaryFile(null)}
