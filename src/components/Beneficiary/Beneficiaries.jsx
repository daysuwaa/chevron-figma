  ...
  return (
    <div className="bg-[#F6F6F6] h-full">
      ...
      <div className="flex ml-auto justify-end items-center mx-5 md:px-[10px] mt-8">
        <button
          className="bg-[#3B2774] py-1.5 px-3 rounded text-center text-white text-sm gap-8"
      ...
      <div className="flex flex-col items-center mt-[8rem]">
        ...
        <button
          className="py-1.5 px-3 text-[#1C065A] text-[14px] sm:text-[16px] mt-4 rounded bg-white  text-center flex items-center justify-center"
          style={{
