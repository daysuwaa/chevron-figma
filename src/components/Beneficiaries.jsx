  ...
  return (
    <div className='bg-[#F6F6F6] h-full'>
      ...
      <div className='flex flex-col items-center mt-[8rem]'>
        ...
        <p className='text-center text-[#1C065A] font-light tracking-wide text-xl'>No Beneficiaries added</p>
        <p className='text-center text-[#718096] font-light tracking-wide text-sm'> You do not have any Beneficiaries. <br></br>
        ...
        <button  className ='text-[#1C065A] mt-2'>Get Beneficiary Template</button>
      </div>
      </div>
    </div>
  );
